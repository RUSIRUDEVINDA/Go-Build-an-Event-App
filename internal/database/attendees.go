...
// Insert — Attendee එකක් database එකට add කරන function එක
...
// GetByEventAndAttendee — given eventId + userId, return the attendee if exists
...
// GetAttendeesByEvent — given eventId, return all attendees for that event
